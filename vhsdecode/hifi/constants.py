...
# *********************
# Betamax HiFi Filter Parameters
# *********************
# NOTE: Beta HiFi used Sony's own companding noise-reduction system. Its actual
# pre-emphasis / expander time constants could not be found in any available
# source (IEC/PALsite/Sony service manuals). As a starting approximation these
# reuse the VHS (IEC 60774-2) NR constants. They MUST be tuned against a real
# Beta HiFi RF sample before being considered correct.
DEFAULT_BETAMAX_AUDIO_MODE = DEFAULT_VHS_AUDIO_MODE
DEFAULT_BETAMAX_EXPANDER_GAIN = DEFAULT_VHS_EXPANDER_GAIN
DEFAULT_BETAMAX_EXPANDER_RATIO = DEFAULT_VHS_EXPANDER_RATIO
DEFAULT_BETAMAX_EXPANDER_ATTACK_TAU = DEFAULT_VHS_EXPANDER_ATTACK_TAU
DEFAULT_BETAMAX_EXPANDER_HOLD_TAU = DEFAULT_VHS_EXPANDER_HOLD_TAU
DEFAULT_BETAMAX_EXPANDER_RELEASE_TAU = DEFAULT_VHS_EXPANDER_RELEASE_TAU
DEFAULT_BETAMAX_DEEMPHASIS_TAU_1 = DEFAULT_VHS_DEEMPHASIS_TAU_1
DEFAULT_BETAMAX_DEEMPHASIS_TAU_2 = DEFAULT_VHS_DEEMPHASIS_TAU_2
DEFAULT_BETAMAX_NR_DEEMPHASIS_TAU_1 = DEFAULT_VHS_NR_DEEMPHASIS_TAU_1
DEFAULT_BETAMAX_NR_DEEMPHASIS_TAU_2 = DEFAULT_VHS_NR_DEEMPHASIS_TAU_2
DEFAULT_BETAMAX_EXPANDER_WEIGHTING_TAU_1 = DEFAULT_VHS_EXPANDER_WEIGHTING_TAU_1
DEFAULT_BETAMAX_EXPANDER_WEIGHTING_TAU_2 = DEFAULT_VHS_EXPANDER_WEIGHTING_TAU_2
DEFAULT_BETAMAX_EXPANDER_WEIGHTING_LOW_PASS = DEFAULT_VHS_EXPANDER_WEIGHTING_LOW_PASS
DEFAULT_BETAMAX_EXPANDER_WEIGHTING_LOW_PASS_TRANSITION = DEFAULT_VHS_EXPANDER_WEIGHTING_LOW_PASS_TRANSITION

# set the amount of spectral noise reduction to apply to the signal before deemphasis
DEFAULT_SPECTRAL_NR_AMOUNT = 0
